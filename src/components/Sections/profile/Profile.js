...
const Profile = ({ currentUser }) => {
    ...
    const requestProfile = async (id) => {
        try {
            ...
            if (id === currentUser._id) { setIsMe(true) }
            else { setIsMe(false) };
    ...
    return (
        <div className="profile-container">
            ...
            <div className="row gy-sm-5 cover-container border-bottom bg-white w-100 m-0 p-0 " >
                ...
                {user.length > 0 ? <div className="col-12 profile-cover mt-0 border">
                    <img src={user[0].cover_img} className="rounded" alt="" />
                    <div className="profile-cover-main d-flex justify-content-center w-100">
                        <img src={user[0].cover_img} className="rounded" alt={currentUser.name} />
                        {isMe && <div className="position-absolute d-flex justify-content-center w-100" style={{ bottom: "0", zIndex: "100" }}>
                            <div className="d-flex justify-content-end" style={{ width: "90%" }}>
                                <button type="button" class="btn btn-secondary " data-bs-toggle="modal" data-bs-target="#changeCover">
                    ...
                    <div className="cover-bottom d-flex flex-column justify-content-center w-100" >
                        <div className="d-flex justify-content-center w-100 position-relative" >
                            <div className="profile-img rounded-pill bg-white">
                                {user.length > 0 ? user[0].profile_img ? <img src={user[0].profile_img} className="rounded-pill" alt="" />
                                    : <span className="bi bi-person-circle"></span> : null}
                            </div>
                            {isMe && <div className="position-absolute d-flex justify-content-end" style={{ bottom: "0", width: "110px", zIndex: "100" }}>
                                <button type="button" class="btn btn-secondary bi bi-camera rounded-pill" data-bs-toggle="modal" data-bs-target="#changeProfile">
            ...
            <div class="modal fade" id="changeCover" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="changeCoverLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Change your cover picture</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form action="" id="changeCoverPic" onSubmit={e => setCoverPic(e)}>
                        ...
                        <div class="modal-footer">
                            <button type="submit" ref={chngCoverbtn} form="changeCoverPic" disabled className="btn btn-primary">
                                <span class="spinner-border spinner-border-sm me-3 d-none" ref={setCoverSpinner} role="status" aria-hidden="true"></span>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="submit" ref={chngProfilebtn} form="changeProfilePic" disabled className="btn btn-primary">
                                <span class="spinner-border spinner-border-sm me-3 d-none" ref={setProfSpinner} role="status" aria-hidden="true"></span>
                ...
                <div className="row row-cols-1 row-cols-md-2 gy-2 gy-md-0 mt-lg-3 px-sm-3 px-md-5 bottom-row gx-4">
                    ...
                    <div className="col">
                        <div className="row row-cols-1 gy-3 bottom-left">
                            {isMe && <div className="col px-3 py-3 bg-white border rounded">
                            ...
                            {isMe && <div className="col p-3 bg-white border rounded">
                                <h3><b>Intro</b></h3>
                                <button className="btn btn-light w-100 mt-2 mb-3"> Edit Details </button>
                                <button className="btn btn-light w-100 mb-3"> Add Hobbies </button>
                                <button className="btn btn-light w-100 mb-3"> Add Features </button>
                            ...
                            <div className="col bg-white border rounded p-3">
                                ...
                                {albumReverse.length && <div className="row row-cols-2 gx-3 gy-2">
                                    <div className="col p-1">
                                        <div className="border">
                                            <img src={albumReverse[0]} alt="" style={{ height: '125px', width: "100%", padding: ".3rem" }} />
                                        </div>
                                    </div>
                                    <div className="col p-1">
                                        <div className="border">
                                            <img src={albumReverse[1]} alt="" style={{ height: '125px', width: "100%", padding: ".3rem" }} />
                                        </div>
                                    </div>
                                    <div className="col p-1">
                                        <div className="border">
                                            <img src={albumReverse[2]} alt="" style={{ height: '125px', width: "100%", padding: ".3rem" }} />
                                        </div>
                                    </div>
                                    <div className="col p-1">
                                        <div className="border">
                                            <img src={albumReverse[3]} alt="" style={{ height: '125px', width: "100%", padding: ".3rem" }} />
                                        </div>
                                    </div>
                                </div>}
                            </div>
                        ...
                        <div className="row row-cols-1 gy-4">
                            ...
                            <div className="col bg-white border rounded">
                                <div className="row justify-content-center align-items-center">
                                    {isMe ? <div className="col-3 pt-3 pb-3">
                                        {currentUser.image ? <img src={currentUser.image} className="postimg rounded-pill" alt={currentUser.name} />
                                            : <span className="bi bi-person-circle ps-3" style={{ fontSize: "1.5rem" }}></span>}
                                    </div>
                                        :
                                        <div className="col-3 pt-3 pb-3">
                                            {user.length && user[0].profile_img ? <img src={user[0].profile_img} className="postimg rounded-pill" alt={user[0].name} />
                                                : <span className="bi bi-person-circle ps-3" style={{ fontSize: "1.5rem" }}></span>}
                                        </div>
                                    }
                                    {isMe ? <div className="col-9 pe-5 pt-3 pb-3">
                                        <div className="bg-light statuscol border">
                                            <form action="">
                                                <input type="text" data-bs-toggle="modal" data-bs-target="#profcreatepost" placeholder={`What's on your mind, ${currentUser.name}?`} className="form-control profstatusinp bg-light" disabled />
                                            </form>
                                        </div>
                                    </div>
                                        :
                                        <div className="col-9 pe-5 pt-3 pb-3">
                                            <div className="bg-light statuscol border">
                                                <form action="">
                                                    {user.length && <input type="text" data-bs-toggle="modal" data-bs-target="#profcreatepost" placeholder={`Post on ${user[0].name}'s timeline'`} className="form-control profstatusinp bg-light" disabled />}
                                                </form>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal fade" id="profcreatepost" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="profcreatepostLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                        ...
                                                        <div className="row gy-2 gx-2 px-0 px-sm-3">
                                                            ...
                                                            <div className="col-12">
                                                                <textarea name="status" className="form-control postinp" placeholder={`Whats on yout mind, ${currentUser.name}?`}
                                                                    id="status" value="{userPost}" onChange="{e => setUserPost(e.target.value)}" required>
                                    ...
                                    <div className="">
                                        <div className="text-center">
                                            <h4 className="text-center">
                                                <span className="spinner-border spinner-border-md me-2" ref={postLoader}></span>
